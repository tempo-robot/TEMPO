...
class PaliGemmaWithExpertModel(nn.Module):
    def __init__(
        ...
        tempo_mot_temporal_period: int = 4,
    ):
        ...
        # TEMPO-MOT: apply the video encoder's space-time attention on every N-th ViT layer.
        vlm_config_hf.vision_config.tempo_mot_temporal_period = tempo_mot_temporal_period
